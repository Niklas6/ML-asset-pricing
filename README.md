...
The project uses a walk-forward prediction design rather than a random train/test split. At each annual step, the models are trained on the previous 20 years of monthly stock observations and then used to predict the next 12 month. The models are refit once per year.
